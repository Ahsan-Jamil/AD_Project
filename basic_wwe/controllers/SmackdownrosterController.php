...
use Yii;
use app\models\Smackdownroster;
use app\models\SmackdownrosterSearch;
 ...
 */
class SmackdownrosterController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new SmackdownrosterSearch();
    ...
    {
        if (($model = Smackdownroster::findOne($id)) !== null) {
            return $model;
        } else {
