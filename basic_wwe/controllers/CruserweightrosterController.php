...
use Yii;
use app\models\Cruserweightroster;
use app\models\CruserweightrosterSearch;
 ...
 */
class CruserweightrosterController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new CruserweightrosterSearch();
    ...
    {
        if (($model = Cruserweightroster::findOne($id)) !== null) {
            return $model;
        } else {
