...
use Yii;
use app\models\Rawroster;
use app\models\RawrosterSearch;
 ...
 */
class RawrosterController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new RawrosterSearch();
    ...
    {
        if (($model = Rawroster::findOne($id)) !== null) {
            return $model;
        } else {
